...
CREATE TABLE `notification_recipients` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_notification_recipient` (`notification_id`,`recipient_email`),
  KEY `recipient_email` (`recipient_email`),
  KEY `notification_id` (`notification_id`),
  CONSTRAINT `notification_recipients_ibfk_1` FOREIGN KEY (`notification_id`) REFERENCES `notifications` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notification_targets` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique_notification_target` (`notification_id`,`target_email`),
  KEY `notification_id` (`notification_id`),
  CONSTRAINT `notification_targets_ibfk_1` FOREIGN KEY (`notification_id`) REFERENCES `notifications` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `park_likes` VALUES (2,'eee@gmail.com','2024-12-30 04:47:30'),(2,'sss@gmail.com','2024-12-30 12:49:08'),(3,'bbb@gmail.com','2025-01-17 02:31:39'),(3,'eee@gmail.com','2024-12-30 04:47:43'),(4,'hal@gmail.com','2025-01-30 07:53:20'),(7,'bbb@gmail.com','2025-01-17 13:54:14'),(7,'hal@gmail.com','2025-01-30 07:53:10'),(10,'eee@gmail.com','2024-12-30 05:46:09'),(11,'eee@gmail.com','2024-12-30 05:46:11'),(12,'sss@gmail.com','2024-12-30 12:49:01'),(14,'bbb@gmail.com','2025-01-14 03:33:40'),(15,'sss@gmail.com','2024-12-30 12:43:04');
...
-- Dump completed on 2025-02-01 19:36:22
