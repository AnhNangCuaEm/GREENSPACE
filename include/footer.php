<div class="footer-container">
    <div class="footer-box">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="200"
            zoomAndPan="magnify" viewBox="95 100 180 180" height="100" preserveAspectRatio="xMidYMid meet"
            version="1.0">
            <defs>
                <g />
        ...
        <p>GREEN SPACEは,リラックスしたい方々のために,自然の中や街中の特定の場所やイベント情報を提供することを目的としたウェブサイトです。このプロジェクトは,学習の一環として開発され,ユーザーに心地よい体験を提供することを目指しています。</p>
    </div>
    <hr class="footer-hr">
    <div class="footer-box">
        <h4>サイトマップ</h4>
    ...
    <div class="footer-box">
        ...
        <ul>
            ...
            <li><a href="mailto:thanhhailth1302@gmail.com">
                    <div>
                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg" stroke="fcf8db">
                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                                <path
